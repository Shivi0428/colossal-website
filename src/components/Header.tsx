    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-18 flex items-center justify-between" style={{ height: 72 }}>
        ...
        <a href="#top" className="flex items-center gap-2.5 shrink-0">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center font-extrabold text-slate-900" style={{ background: "linear-gradient(135deg, #22d3ee, #2dd4bf)", boxShadow: "0 0 20px rgba(34,211,238,0.5)" }}>
            C
          </div>
        ...
        <div className="hidden lg:block">
          <a
            ...
            style={{ border: "1px solid rgba(34,211,238,0.4)", background: "transparent" }}
            onMouseEnter={(e) => {
